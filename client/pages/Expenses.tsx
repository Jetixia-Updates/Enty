    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-1">Track your spending</p>
        </div>
        ...
        <Card className="glass">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Wallet className="w-5 h-5" /> This month
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass">
          ...
          <CardContent>
            {loading ? (
              ...
              <p className="text-zinc-500 py-8">No expenses yet</p>
            ) : (
